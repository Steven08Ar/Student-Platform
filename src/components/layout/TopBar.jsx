    ...
    return (
        <div className="h-20 w-full bg-transparent px-8 flex items-center justify-between z-10">
            ...
            <div className="flex items-center gap-4">
                ...
                {/* Profile Pill - Direct Navigation to Settings */}
                <div
                    onClick={() => navigate('/settings')}
                    className="flex items-center gap-3 bg-white pl-1 pr-4 py-1 rounded-full shadow-sm ml-2 cursor-pointer hover:shadow-md transition-shadow select-none"
                    role="button"
                    tabIndex={0}
                >
